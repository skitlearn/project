# Image segmentation, geotechnical detection using AB algorithm
import numpy as np
import cv2
...
class LabDetector(object):
    def __init__(self,_img_arr):
        ...
        self.processed_bgr_arr = 0  # Array of processed images
...
if __name__ == '__main__':
    img_path = r"I:\Projects\SoilMonitor\src\takePictures\picture\20190513_165324.jpg"
